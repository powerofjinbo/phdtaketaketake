#!/usr/bin/env python3
"""Thin shim — see phd_matcher/cli/audit_candidates.py for the actual implementation.
...
After `pip install` the canonical entry point is the console script:
    phdtaketaketake-audit-candidates ...
"""
...
from phd_matcher.cli.audit_candidates import main
