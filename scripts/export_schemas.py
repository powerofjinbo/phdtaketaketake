#!/usr/bin/env python3
"""Thin shim — see phd_matcher/cli/export_schemas.py for the actual implementation.
...
After `pip install` the canonical entry point is the console script:
    phdtaketaketake-export-schemas ...
"""
...
from phd_matcher.cli.export_schemas import main
